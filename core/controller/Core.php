...
class Core {
	...
	public static function includeImage($imageName, $alt = "", $class = "") {
		$path = "res/images/" . $imageName;
		if (file_exists($path)) {
			echo "<img src='" . $path . "' alt='" . htmlspecialchars($alt) . "' class='" . htmlspecialchars($class) . "' />";
		} else {
